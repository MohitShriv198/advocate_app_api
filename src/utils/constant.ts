...
export const USER_ALREADY_CREATED =
  'The email address has already been registered';
export const PHONE_ALREADY_USED =
...
export const USER_SECURITY_ANSWER_INCORRECT =
...
export const TWILIO_OTP_MSG =
  'Your Genie Calculator OTP for phone number verification is: ';
export const TWILIO_FORGOT_PASSWORD_MSG =
  'Your Genie Calculator Temporary Password is: ';
export const PWD_SENT_TO_PHONE =
  'Temporary Password sent to your registered phone number';
export const OTP_SENT_TO_PHONE = 'OTP sent to your registered phone number';
export const PWD_SENT_TO_EMAIL =
  'Temporary Password sent to your registered email';
export const OTP_SENT_TO_EMAIL = 'OTP sent to your registered email';
